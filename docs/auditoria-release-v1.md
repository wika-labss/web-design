...
Validar que la iteración es publicable: Fase 1 (HTML semántico) completa y, si aplica, Fase 2 (dirección visual) aplicada según MOD-DIR.
...
- Documentación oficial en `proyectos/web/{proyecto}/idea/` (01–04) con gates de construcción en `true`.
